...
class FallbackCompanyProfile:
    def __init__(self, organization):
        ...
        self.trade_name = organization.name or "Marmoraria Santander"
        self.legal_name = organization.legal_name or "Santander Mármores e Granitos LTDA"
        ...
        self.email = organization.email or "comercial@santandermarmoraria.com.br"
        self.website = "www.santandermarmoraria.com.br"
        self.address = "Av. Exemplo Comercial, 1000 - Centro"
        self.city = "São Paulo"
        self.state = "SP"
        self.business_hours = "Segunda a Sexta: 08:00 às 18:00"
        self.slogan = "Qualidade e sofisticação em mármores e granitos"
        self.footer_text = "Orçamento gerado por Marmoraria Santander - Todos os direitos reservados."
        self.default_terms = "Pagamento: 50% de sinal e 50% na entrega. Prazo de entrega: 15 dias úteis após medição final."
        self.default_estimate_validity = 15
        self.privacy_policy = "Esta é a política de privacidade da Marmoraria Santander."
        self.terms_of_use = "Estes são os termos de uso do sistema da Marmoraria Santander."
        self.logo = None
        self.is_active = True
